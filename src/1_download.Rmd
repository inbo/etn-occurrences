...
Extract tags associated with animals:
...
Extract receivers found in detections:
...
```{r}
deployments <- get_deployments(con, open_only = FALSE)
```

Select deployments for receivers with detections:
...
```{r}
write_csv(animals, here::here("data", dataset$project_code, "animals.csv"), na = "")
write_csv(tags, here::here("data", dataset$project_code, "tags.csv"), na = "")
write_csv(detections, here::here("data", dataset$project_code, "detections.csv"), na = "")
write_csv(receivers, here::here("data", dataset$project_code, "receivers.csv"), na = "")
write_csv(deployments, here::here("data", dataset$project_code, "deployments.csv"), na = "")
```
