...
This script has been designed to extract information from the LifeWatch European Tracking Network (ETN) database. The following code is generated to download metadata about **animals**, **tags**, **receivers** and **deployments**, and data about **detections** from one of the following animal projects x scientific name combinations. Please specify for which animal project you want to extract data under section `Define selection criteria` 
