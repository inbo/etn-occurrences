...
# Correct html
new_abstract <- paste0("<p>", abstract, "</p>", additional_info) %>% 
...
new_abstract <- paste0(
  unlist(strsplit(new_abstract, " Data were exported from", perl = TRUE))[[1]],
  "</p>"
)
...
# Add last paragraph
eml$dataset$abstract$para <- paste0(new_abstract, new_paragraph)
