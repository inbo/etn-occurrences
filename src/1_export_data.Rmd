...
This script is used to export data from the etn database to the [raw data folder]() in this repository. The goal is to simplify data exploration.
...
query <- glue_sql("
  ...
  WHERE animal_id_pk = 486
  LIMIT 100
  ",
  .con = my_con)

individual_detections <- dbGetQuery(my_con, query)
as_tibble(individual_detections)
```
