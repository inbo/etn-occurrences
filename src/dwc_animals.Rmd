...
measurementType = "anaesthetic"
measuremntUnit = "anaesthetic concentration"
measurementValue = "anaesthetic concentration"
...
Remove all values for which post operation holding period is not empty (only concerns one value):
