...
```{r}
event_receiver_deployments_data %>% 
  write_csv(here::here("data","processed", "dwc_event_receiver_deployments.csv"),
            na = "")
```
...
```{r}
write_csv(emof_receiver_deployments_data,
          here::here("data","processed", "dwc_emof_receiver_deployments.csv"),
          na = "")
```
